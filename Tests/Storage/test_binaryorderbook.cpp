...
protected:
    ...
    BinaryOrderBookTest() : pool(), book(pool) {}
...
TEST_F(BinaryOrderBookTest, GetBestBid_EmptyBook_ReturnsZero) {
    EXPECT_EQ(book.GetBestBid(), UINT32_MAX);
}

TEST_F(BinaryOrderBookTest, GetBestAsk_EmptyBook_ReturnsZero) {
...
TEST_F(BinaryOrderBookTest, CancelOrder_OnlyRemovesTarGet) {
    AddBuy(1, 100, 10);
    AddBuy(2, 105, 10);
    book.CancelOrder(1);
